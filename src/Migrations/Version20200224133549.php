 ...
 */
final class Version20200224133549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE picture DROP filename_png');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE picture ADD filename_png VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE product CHANGE quantity quantity INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stock CHANGE product_id product_id INT DEFAULT NULL');
