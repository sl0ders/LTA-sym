 ...
 */
final class Version20200224141513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD filename_png VARCHAR(255) NOT NULL, CHANGE quantity quantity INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP filename_png, CHANGE quantity quantity INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stock CHANGE product_id product_id INT DEFAULT NULL');
