 ...
 */
final class Version20200219080517 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD product_id INT NOT NULL, ADD n_cmd INT NOT NULL, DROP user_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id INT DEFAULT NULL, DROP product_id, DROP n_cmd');
